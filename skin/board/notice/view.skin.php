...
<div style="float: left; width: 100%; border-top: 1px solid #000; border-bottom: 1px solid #b0b0b0; padding: 1rem 0px; margin-bottom: 6rem;">
	<h1 style="float:left;margin-top: 5px;font-size:28px"><?php if($view['photo']) { ?><img src="<?php echo $view['photo'];?>" class="photo" alt=""><?php } ?><?php echo cut_str(get_text($view['wr_subject']), 70); ?></h1>
...
<div class="view-wrap<?php echo (G5_IS_MOBILE) ? ' view-mobile font-14' : '';?>">
	...
	<?php  
		...
		$sql = "SELECT * FROM  g5_write_notice WHERE wr_id = $view[wr_id]+1";
		$sqll = "SELECT * FROM  g5_write_notice WHERE wr_id = $view[wr_id]-1";
		$sqql = "SELECT * FROM  g5_write_notice WHERE wr_id = $view[wr_id]+1";
		$sqqll = "SELECT * FROM  g5_write_notice WHERE wr_id = $view[wr_id]-1";
	...
	<div class="print-hide view-btn text-right">
		<div class="btn-group" style="width:100%; font-family: 'Noto Sans KR', sans-serif;">
			<?php if ($prev_href) { ?>
				<a href="<?php echo $prev_href ?>" class="btn btn-black btn-sm" title="이전글" style="width:100%; border-top: 1px solid #000; padding: 20px 0px; font-family: none;">
					<div style="width:100%; float:left; font-size:1.5rem; font-family: 'Noto Sans KR', sans-serif;">
			...
			<?php }else{ ?>
					<div style="width:100%; float:left; font-size:1.5rem; border-top: 1px solid #e7e7e7; padding: 20px 0px; color: #e7e7e7; font-family: 'Noto Sans KR', sans-serif;">
