...
<div class="table-responsive">
	...
	<tr style="height: 60px; border-top: 2px solid #646464; border-bottom: 1px solid #d7d7d7;">
		...
		<th scope="col">제목</th>
		<th scope="col">&nbsp;</th>
		<th scope="col" style="width: 60px;"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>등록일</a></th>
		<th scope="col" style="width: 100px;"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?><nobr>조회</nobr></a></th>
		<?php if($is_good) { ?>
	...
	?>
	<tr<?php echo $tr_css; ?> style="height: 50px;">
		<?php if ($is_checkbox) { ?>
