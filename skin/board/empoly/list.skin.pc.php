...
<div class="table-responsive">
	...
	<thead>
	<tr style="height: 60px; border-top: 2px solid #646464; border-bottom: 1px solid #d7d7d7;">
		<?php if ($is_checkbox) { ?>
		<th scope="col">
		...
		<?php } ?>
		<th scope="col" style="width: 60px; font-size: 18px;">번호</th>
		...
		<?php if($is_category) { ?>
			<th scope="col">분류</th>
		<?php } ?>
		<th scope="col" style="width: 60px; font-size: 18px;">대상</th>
		<th scope="col" style="font-size: 18px;">채용정보</th>
		<th scope="col">&nbsp;</th>
		<th scope="col" style="width: 140px; font-size: 18px;"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>등록일</a></th>
		<th scope="col" style="width: 140px; font-size: 18px;">접수기간</th>
		<th scope="col" style="width: 170px; font-size: 18px;"><nobr>접수상태</nobr></a></th>
		<?php if($is_good) { ?>
	...
	?>
	<tr<?php echo $tr_css; ?> style="height: 50px; font-size: 16px !important;">
		<?php if ($is_checkbox) { ?>
		...
		<?php } ?>
		<td class="text-center en font-11"><?php echo $list[$i]['wr_4'] ?></td>
		...
		<td><b></b></td>
		<td class="text-center en font-11"><?php echo apms_date($list[$i]['date'], 'orangered', 'Y.m.d','Y.m.d','Y.m.d'); ?></td>
		<td class="text-center en font-11"><?php echo $list[$i]['wr_1'] ?> ~ <?php echo $list[$i]['wr_2'] ?></td>
		<td class="text-center en font-11"><?php echo $list[$i]['wr_3'] ?></td>
		<?php if ($is_good) { ?>
