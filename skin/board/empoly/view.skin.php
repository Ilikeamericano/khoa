		...
		<div class="sel-con">
			...
			<div class="boxx" style="margin-left: 250px;">
			  <div class="selectBox2" style="border-left: none;">
				<button class="label">채용공고<img src="<?php echo G5_IMG_URL?>/under_ang.png" style="margin-left: 75px; transition: transform 0.3s;"></button>
...
<div style="float: left; width: 100%; border-top: 1px solid #000; border-bottom: 1px solid #b0b0b0; padding: 1rem 0px; margin-bottom: 6rem;">
	...
	<div style="float: right; font-size: 14px; font-weight: bold; padding-top: 1.3rem;">모집기간: <?php echo $view['wr_1'] ?> ~ <?php echo $view['wr_2'] ?></div>
</div>	
<div class="view-wrap<?php echo (G5_IS_MOBILE) ? ' view-mobile font-14' : '';?>">
	...
	<?php  
		...
		$sql = "SELECT * FROM  g5_write_empoly WHERE wr_id = $view[wr_id]+1";
		$sqll = "SELECT * FROM  g5_write_empoly WHERE wr_id = $view[wr_id]-1";
		$sqql = "SELECT * FROM  g5_write_empoly WHERE wr_id = $view[wr_id]+1";
		$sqqll = "SELECT * FROM  g5_write_empoly WHERE wr_id = $view[wr_id]-1";
