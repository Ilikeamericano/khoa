...
<section class="board-list<?php echo (G5_IS_MOBILE) ? ' font-14' : '';?>">
	...
	<style>
		.at-container .list-container { overflow:hidden; margin-right:<?php echo ($gap_right > 0) ? '-'.$gap_right : 0;?>px; margin-bottom:<?php echo ($gap_bottom > 15) ? 0 : 15;?>px; }
		.at-container .list-row { float:left; width:<?php echo $item_w;?>%; }
		.at-container .list-item { margin-right:<?php echo $gap_right;?>px; margin-bottom:<?php echo $gap_bottom;?>px; }
		.at-container .list-item:hover{ }
		.img-item a:hover{ cursor : crosshair; transition: transform 1s; filter: brightness(70%);}
		.hi-top{
	...
	<div class="list-wrap">
					...
					<div class="sel-con">
						<div class="boxx" style="margin-left: 50px;">
						  <div class="selectBox2 ">
							<button class="label">연구개발<img src="<?php echo G5_IMG_URL?>/under_ang_b.png" style="margin-left: 85px;"></button>
							<ul class="optionList">
						...
						<div class="boxx" style="margin-left: 250px;">
						  <div class="selectBox2" style="border-left: none;">
							<button class="label">국내외 특허<img src="<?php echo G5_IMG_URL?>/under_ang.png" style="margin-left: 75px;"></button>
							<ul class="optionList">
		...
		<form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post" role="form" class="form">
			<div class="at-container">
				...
				<div style="float: left; width: 100%;">
					<ul style="list-style: none; padding: 0;margin: 0; margin-bottom: 6rem;">
						<a href="<?php echo G5_BBS_URL?>/board.php?bo_table=patent" class="tab-01"><li class="title-menu-4">행정기관</li></a>
						<a href="<?php echo G5_BBS_URL?>/board.php?bo_table=patent2" class="tab-02"><li class="title-menu-4">인증기관</li></a>
						<a href="<?php echo G5_BBS_URL?>/board.php?bo_table=patent3" class="tab-03"><li class="title-menu-4">고객사</li></a>
					</ul>
				</div>
				...
				<!--<div class="list_count">총 <?php echo $list_cnt; ?>개의 개시물이있습니다.</div>-->
		...
		<!--<form name="fsearch" method="get" role="form" class="form" style="margin-top: 20px; position: absolute; width: 400px; top: 610px; margin-left: 78.5rem;">
			...
			<div class="btn-group btn-group-justified"  style="float:right; width: 10%;">
				<div class="btn-group">
					<button type="submit" class="btn btn-color" style="padding-top: 2px;"><i class="fa fa-search"></i></button>
				</div>
			</div>
			<div class="form-group"  style="float:right; width: 58%;">
				<label for="stx" class="sound_only">검색어<strong class="sound_only"> 필수</strong></label>
				<input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx" class="form-control input-sm" maxlength="20" placeholder="검색어">
			</div>
		</form>-->
