...
.table-content-i:hover .content-big-day{
	color: #000 !important;
}
.table-content-i:hover .content-title{
	text-decoration: underline;				<!-- 마우스 hover 시 title 에 밑줄 -->
}
.content-left-day{
	float: left;
    margin-right: 4%;
	...
	<div class="list-wrap">
					...
					<div class="sel-con">
						...
						<div class="boxx" style="margin-left: 250px;">
						  <div class="selectBox2" style="border-left: none;">
							<button class="label">보도자료<img src="<?php echo G5_IMG_URL?>/under_ang.png" style="margin-left: 75px; transition: transform 0.3s;"></button>
							<ul class="optionList" style="width: 201px;">
							  <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=gallery"><li class="optionItem">미디어 룸</li></a>
							</ul>
						  </div>
						</div>
					</div>
		...
		<form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post" role="form" class="form">
			<div class="at-container">
				...
				?>
				<div class="list_count">총 <?php echo $board_total; ?>개의 개시물이있습니다.</div>
			<?php 
			...
			<?php
				...
				$conn = mysqli_connect("localhost", "sungtaek12", "sungtaek1!" , "sungtaek12");
				$sql = "SELECT * FROM  g5_write_news WHERE wr_id = $view[wr_id]+1";
				$result = mysqli_query($conn, $sql);
			...
			<div class="table-content-i">
				<div class="content-left-day">
					<div class="content-big-day"><?php echo date('d',$timedate); ?></div>
					<div class="content-big-y-m"><?php echo substr($list[$i]['datetime'],0,7); ?></div>
				</div>
				<div class="content-center">
					<div class="content-title"><?php echo $list[$i]['wr_subject'] ?></div>
					<div class="content-sub-title"><?php echo $list[$i]['wr_content'] ?></div>
				</div>
				<div class="content-right-image">
					<img src="<?php echo $img['src'];?>" alt="<?php echo $img['alt'];?>" style="float: left; width: 100%;">
				</div>
			</div>
			</a>
			<?php }?>
			<div style="float: left; width: 100%; background: #000; height: 1px;">&nbsp;</div>
