			...
			<div class="boxx" style="margin-left: 50px;">
			  <div class="selectBox2 ">
				...
				<ul class="optionList">
					...
					<a href="<?php echo G5_BBS_URL?>/page.php?hid=history"><li class="optionItem">뉴스룸</li></a>
...
<div style="float: left; width: 100%; border-top: 1px solid #000; border-bottom: 1px solid #b0b0b0; padding: 1rem 0px; margin-bottom: 6rem;">
		...
		<div class="panel-heading">
			<div class="font-12 text-muted">
				...
				<span class="pull-right">
					...
					<?php echo date('y-m-d', $view['date']); //시간 ?>
				</span>
			</div>
		</div>
	   <?php
	...
	<?php  
		...
		$sqll = "SELECT * FROM  g5_write_news WHERE wr_id = $view[wr_id]-1";
		$sqql = "SELECT * FROM  g5_write_news WHERE wr_id = $view[wr_id]+1";
		$sqqll = "SELECT * FROM  g5_write_news WHERE wr_id = $view[wr_id]-1";
