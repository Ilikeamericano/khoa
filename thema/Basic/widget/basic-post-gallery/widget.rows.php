...
?>
	<div class="post-row" style="width:33.33%;">
		<div class="post-list">
			...
			<div class="post-content<?php echo $is_center;?>">
				<div class="post-subject" style="text-align: start;">
					<a href="<?php echo $list[$i]['href'];?>"<?php echo $is_modal_js;?><?php echo $target;?> style="font-size: 17px; font-weight: bold;">
						<?php// echo $wr_icon;?>
				...
				<div class="post-text post-ko txt-short ellipsis<?php echo $is_center;?><?php echo $is_details;?>" style="text-align: start; font-size: 13px; font-weight: bold; padding-top: 10px;">
					<?php /*echo $list[$i]['name'];*/echo ($is_dtxt) ? apms_datetime($list[$i]['date'], $is_dtype) : date($is_dtype, $list[$i]['date']); ?>
